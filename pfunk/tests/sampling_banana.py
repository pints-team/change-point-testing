...
class SamplingBanana(pfunk.FunctionalTest):
    """
    ...
    def __init__(self, method, nchains):
        ...
        name = 'sampling_banana_' + self._method + '_' + str(self._nchains)
        super(SamplingBanana, self).__init__(name)
    ...
    def _plot(self, results):
        ...
        plt.title('Sampling on Banana with ' + self._method)
        plt.xlabel('Commit')
